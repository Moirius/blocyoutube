...
# Chemin absolu vers le custom_prompts.json à la racine du projet
...
def render_tab():
    ...
    prompts["STORY_PROMPT_TEMPLATE"] = st.text_area(
        "Prompt de départ", value=prompts.get("STORY_PROMPT_TEMPLATE", ""), height=200
    )
    ...
    if st.button("💾 Enregistrer les prompts"):
        ...
        st.success("✅ Prompts enregistrés avec succès dans `custom_prompts.json`.")
